...
router.get("/", async (req, res) => {
  try {
    ...
    for (var i = length - 1; i >= 0; i--) {
      ...
      let formattedEndTime = new Intl.DateTimeFormat("en-GB", {
        year: "numeric",
        month: "2-digit",
        day: "2-digit",
        hour: "2-digit",
        minute: "2-digit",
      }).format(auctions[i].endDateTime);
      let formattedStartTime = new Intl.DateTimeFormat("en-GB", {
        year: "numeric",
        month: "2-digit",
        day: "2-digit",
        hour: "2-digit",
        minute: "2-digit",
      }).format(auctions[i].startDateTime);
